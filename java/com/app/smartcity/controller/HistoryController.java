...
import com.app.smartcity.service.HistoryService;
...
public class HistoryController {
	...
	@GetMapping("/info")
	public ResponseEntity<AllType> getInfo(){
		return new ResponseEntity<AllType>(historyService.getInfo(),HttpStatus.OK);
